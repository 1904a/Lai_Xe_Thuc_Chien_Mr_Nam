...
const benefitList = [
  {
    text: "Trường trực thuộc sở Giao Thông Công Chánh",
    highlight: "(không qua trung gian)",
  },
  {
    text: "Đây là khóa sát hạch lái xe C1",
    highlight: "sớm nhất hiện nay",
  },
  { text: "Thời gian học thực hành lên tới", highlight: "40 giờ/1 học viên" },
  ...
  {
    text: "Hệ thống",
    highlight: "xe tập lái đời mới, có máy lạnh và trợ lực tay lái.",
  },
  { text: "Học phí", highlight: "rõ ràng, minh bạch và cam kết trên hợp đồng" },
  {
...
const headerData = {
  title: "HỌC PHÍ HỌC LÁI XE HẠNG C1 TẠI TPHCM",
...
const leftData = {
  ...
  details: [
    ...
    "Học lý thuyết: <b>online trên phần mềm và học tập trung theo lịch nhà trường.</b>",
    "Thời gian thực hành: <b>40 giờ/1 học viên</b>",
    "Phí hồ sơ đăng ký học lái xe C1",
...
const rightData = {
  ...
  steps: [
    ...
    },
    {
      label: "Lần 2",
      content:
        "Sau khoảng 1 – 2 tháng học viên đóng tiếp <b class='text-red-600'>14.000.000 VNĐ</b>",
    },
  ],
  extraDetails: [
    { title: "Chi tiết số giờ học lý thuyết và thực hành như sau", desc: "" },
    {
      title: "Học lý thuyết",
      desc: "Học online trên phần mềm và học trực tiếp theo lịch nhà trường.",
    },
    {
      title: "Học thực hành cơ bản",
      desc: "Gồm 4 buổi (2 buổi số sàn và 2 buổi tự động). Mỗi buổi 4 tiếng/2 học viên/xe.",
    },
    {
...
const dossierData = {
  ...
  items: [
    ...
    { content: "Đơn đăng ký học lái xe (Trường cấp)" },
  ],
};
...
const step4 = {
  title: "KẾT THÚC KHOÁ",
  items: [
    "Tốt nghiệp kết thúc khóa nhận giấy xác nhận hoàn thành khóa học.",
    "Sau ngày tốt nghiệp 15-20 ngày sẽ sát hạch GPLX C1",
    "Sát hạch GPLX gồm 4 bài: Lý thuyết – Mô phỏng – Sa hình – Đường trường",
    "Đậu sát hạch 5-7 ngày sau tự động cập nhật lên hệ thống VNIED điện tử.",
  ],
};

export default function C1CoursePage() {
  return (
    <main>
      <div className="w-205 h-105.5 mx-auto mt-20">
        <CourseCard data={c1Course} />
      </div>

      <div className="w-full h-192.75 mx-auto mt-7.5">
        <div className="w-307.5 h-192.75 mx-auto grid grid-cols-2 gap-10 p-4">
          <BenefitLayout
            title="TẠI SAO NÊN ĐĂNG KÝ HỌC LÁI XE TẢI HẠNG C1 TẠI KHÔI VIỆT"
            benefits={benefitList}
            note={
              <>
                <strong>Lưu ý:</strong> Rất nhiều văn phòng hiện nay{" "}
                <span className="text-red-600 font-bold underline">
                  không có giấy phép
                </span>{" "}
                nhưng vẫn tuyển sinh và rất nhiều Anh/Chị nộp phải những văn
                phòng như vậy{" "}
                <span className="font-bold text-black">
                  bị lừa tiền không được sát hạch
                </span>{" "}
                hoặc được sát hạch nhưng hồ sơ gửi về các tỉnh khác.
              </>
            }
          />
          <div className="w-[550px] h-[650px] mt-25">
            <div className="w-full h-full bg-[#D32F2F] rounded-[40px] p-8 md:p-12 shadow-2xl relative overflow-hidden flex flex-col justify-center">
              ...
              <div className="relative z-10 text-center">
                ...
                <ContactForm courseName="C1" showContentInput={true} />
      ...
      <div className="relative w-full h-242.75 mx-auto overflow-hidden">
        <img
      ...
      <div className="w-307.5 h-139 mx-auto mb-8">
        <div className="w-full h-46.75 flex flex-col items-center justify-center text-center px-4">
          <h2 className="text-red-600 text-[34px] font-bold uppercase mb-4 tracking-tight">
            Địa điểm đón và học thực hành lái xe C1
          </h2>
          <p className="text-gray-700 text-[16px] max-w-[900px] leading-relaxed italic">
            ...
            để thuận tiện cho việc di chuyển và học thực hành lái xe tải hạng
            C1.
          </p>
        </div>
        ...
        <div className="w-307.5 h-243.75 mx-auto">
          <div className="w-full h-36.75 flex items-center justify-center">
            <h2 className="text-[#cc1d1d] text-3xl font-bold uppercase tracking-tight border-b-2 border-red-600 pb-2">
              QUY TRÌNH ĐÀO TẠO HỌC LÁI XE Ô TÔ C1 TẠI KHÔI VIỆT
            </h2>
          </div>
          <div className="flex justify-between px-0">
      ...
      <div className="w-[1230px] h-[975px] mx-auto font-sans mt-5">
        <div className="w-full h-[140px] flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-gray-800 text-[16px] max-w-[1000px] leading-relaxed">
            ...
            . Sân tập đạt chuẩn theo yêu cầu của sở GTVT TPHCM.
          </p>
        </div>
