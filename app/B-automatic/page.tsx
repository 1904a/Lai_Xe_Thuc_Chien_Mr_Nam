...
const benefitList = [
  ...
  {
    text: "Đây là khóa sát hạch lái xe B(số tự động)",
    highlight: "sớm nhất hiện nay",
  },
  { text: "Thời gian học thực hành lên tới", highlight: "30 giờ/1 học viên" },
...
const headerData = {
  title: "HỌC PHÍ HỌC LÁI XE Ô TÔ B TỰ ĐỘNG TẠI TPHCM",
...
const leftData = {
  headerTitle: "HỌC PHÍ TRỌN GÓI HỌC LÁI XE B TỰ ĐỘNG\nTHỰC HÀNH 30 GIỜ",
  ...
  details: [
    ...
    "Thời gian thực hành: <b>30 giờ/1 học viên</b>",
    "Phí hồ sơ đăng ký học lái xe B",
  ...
  steps: [
    {
      label: "Lần 1",
      content:
        "Nộp hồ sơ và đóng học phí <b class='text-red-600'>9.000.000 VNĐ</b>",
    },
    {
      label: "Lần 2",
      content:
        "Sau khoảng 1 – 2 tháng học viên đóng tiếp <b class='text-red-600'>10.000.000 VNĐ</b>",
    },
  ],
  extraDetails: [
    ...
    },
    {
      ...
      desc: "Gồm 2 buổi mỗi buổi 2 tiếng hoặc học 1 buổi 4 tiếng tuỳ học viên.",
    },
    { title: "Học DAT 710km", desc: "Gồm 2 ngày mỗi ngày học 10 tiếng" },
    {
      title: "Học sa hình",
      desc: "Gồm 2 buổi mỗi buổi 4 tiếng hoặc học 1 buổi 8 tiếng",
    },
  ],
};
...
const step4 = {
  ...
  items: [
    ...
    "Sau ngày tốt nghiệp 15-20 ngày sẽ sát hạch GPLX B",
    "Sát hạch GPLX gồm 4 bài: Lý thuyết – Mô phỏng – Sa hình – Đường trường",
    "Đậu sát hạch 5-7 ngày sau tự động cập nhật lên hệ thống VNIED điện tử và được phép lái xe.",
  ],
};

export default function Bautomatic() {
  return (
    <main>
      <div className="w-205 h-105.5 mx-auto mt-20">
        <CourseCard data={b1Course} />
      </div>

      <div className="w-full h-192.75  mx-auto mt-7.5">
        <div className="w-307.5 h-192.75  mx-auto grid grid-cols-2 gap-10 p-4">
          <BenefitLayout
            title="TẠI SAO NÊN ĐĂNG KÝ HỌC LÁI XE Ô TÔ B(SỐ TỰ ĐỘNG) TẠI KHÔI VIỆT"
            ...
            note={
              <>
                ...
                hoặc được sát hạch nhưng hồ sơ gửi về các tỉnh khách.
              </>
            }
          />
      ...
      <div className="w-full h-138.5  mx-auto bg-gray-200">
        ...
        <div className="flex justify-center px-100 gap-20 ">
